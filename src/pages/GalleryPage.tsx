  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          <h1 className="text-3xl font-bold font-playfair">Community Gallery</h1>
          <p className="text-gray-600">Explore creations from our community</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
          <div className="relative flex-grow">
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-terracotta-300 focus:border-terracotta-400 outline-none"
            />
            {searchQuery && (
              <button 
          ...
          <button
            ...
            className="md:hidden px-4 py-2 border border-gray-300 rounded-lg flex items-center justify-center gap-2"
          >
            <Filter size={16} />
            Filter
          </button>
          ...
          <Link
            to="/gallery/submit"
            className="px-4 py-2 bg-terracotta-600 text-white rounded-lg hover:bg-terracotta-700 transition-colors whitespace-nowrap"
          >
        ...
        <div className="fixed inset-0 bg-black/50 z-50 md:hidden">
          <div className="absolute right-0 top-0 h-full w-80 bg-white p-6 overflow-y-auto">
            ...
            <button 
              ...
              className="w-full py-2 bg-terracotta-600 text-white rounded-lg mt-4"
            >
              Apply Filters
            </button>
          </div>
      ...
      {filteredItems.length > 0 ? (
            ...
            <div key={item.id} className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
              <div className="aspect-square bg-gray-100 relative overflow-hidden">
                ...
                <div className="absolute top-3 right-3 flex space-x-2">
                  <button className="bg-white/80 backdrop-blur-sm text-gray-700 p-1.5 rounded-full hover:bg-white transition-colors">
                    <Heart size={16} />
                  </button>
                  <button className="bg-white/80 backdrop-blur-sm text-gray-700 p-1.5 rounded-full hover:bg-white transition-colors">
                    <Share2 size={16} />
        ...
        <div className="text-center py-12">
          ...
          <button 
            ...
            className="inline-block px-6 py-2 bg-terracotta-600 text-white rounded-full"
          >
            Clear Filters
          </button>
        </div>
